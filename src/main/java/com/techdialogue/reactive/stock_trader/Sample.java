...
public class Sample {
    public static void main(String[] args) {
        ...
        //Only one error or exception is enough to close the data channel
        //separate handlers for ever error but how many ???
        //is there a way to resume on the same data channel

        //on Exception Resume with a new Observable

        //retry strategies upon error on the same channel
